...
<div class="main-header">
    ...
    <p>Tác giả: Vù Văn Thành - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0333119488</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Vù Văn Thành - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0333119488</p>
